...
public class Matrix4 {
	...
	public Vector4 transform(Vector4 right) {
		...
		//matrix[col * 4 + row];
		float x = get(0) * right.x() + get(4) * right.y() + get(8) * right.z() + get(12) * right.w();
		float y = get(1) * right.x() + get(5) * right.y() + get(9) * right.z() + get(13) * right.w();
		float z = get(2) * right.x() + get(6) * right.y() + get(10) * right.z() + get(14) * right.w();
		float w = get(3) * right.x() + get(7) * right.y() + get(11) * right.z() + get(15) * right.w();
