...
public class GeometryLoader {
	...
	private void readPositions() {
		...
		for (int i = 0; i < count/3; i++) {
			...
			Vector4 position = CORRECTION.transform(new Vector4(x, y, z, 1)); // Transform does not alter CORRECTION
	...
	private void readNormals() {
		...
		for (int i = 0; i < count/3; i++) {
			...
			Vector4 norm = CORRECTION.transform(new Vector4(x, y, z, 0f)); // Transform does not alter CORRECTION
